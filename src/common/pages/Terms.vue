      ...
      <div class="container">
        <div id="en" class="tab-content translations-content-item en visible">
          ...
          <ul>
            ...
            <li>
              <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to CSIM, 27 rue Raoul Servant, 69007 Lyon.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to CSIM, accessible from <a href="https://csim-finance.com" rel="external nofollow noopener" target="_blank">https://csim-finance.com</a></p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: contact@csim.com</li>
          </ul>
        </div>
      </div>
    </div>
