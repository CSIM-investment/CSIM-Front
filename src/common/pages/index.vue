  ...
  <div class="flex-col">
    ...
    <section class="flex-col background-landing-page pt-10">
      <div class="flex-col text-center pt-10">
        <h1 class="md:text-5xl xl:text-6xl sm:text-4xl xs:text-3xl font-black"> Le chemin le plus rapide et efficace
          pour </h1>
        <h2 class="xl:text-5xl md:text-4xl sm:text-3xl xs:text-3xl font-black pt-5 sub-title text-color-grey"> Gérer,
          Suivre & Echanger </h2>
        <p class="pt-5"> L'endroit où vous pouvez controller et suivre les cryptommonaies pour mieux investir.</p>
        <Button class="button-landing-page xl:w-1/6 xs:2/6 mt-15 font-bold mb-4 mt-10" type="submit">Se
          connecter</Button>
      </div>
      ...
      <div class="bottom-0 w-full transition-all duration-300 ease-in-out delay-150 ">
        <span></span>
        <div class="wave mt-10"></div>
      </div>
    </section>
    <div class="flex-col list-crypto">
      <DataTable class="rounded-lg" :value="data" responsiveLayout="scroll">
    ...
    <div class="flex justify-center xs:text-center">
      <span class="xl:text-3xl xs:text-2xl font-bold mb-7">Mieux gérer vos cryptomonnaies avec CSIM</span>
    </div>
    <div class="xl:flex-row md:flex-row sm:flex-row flex xs:flex-col card-container justify-around mb-10">
      <div class="card-pres flex-col flex xl:w-1/4 xs:w-full xs:mt-7 mt-8 justify-evenly rounded-lg">
        ...
        <div class="mt-7 mr-5 ml-5">
          ...
          <p class="mt-7 paragraphe">Regarder toutes les cryptommaie avec le market. Regarder les dernières tendances
            pour investire au mieux dans
            votre cryptomonnaie préferé.</p>
        </div>
      </div>
      <div class="card-pres xl:w-1/4 xs:mt-7 flex flex-col justify-evenly rounded-lg">
        <div class="mt-7 mb-3 mr-5 ml-5">
          <span class="font-bold">Suivez à l’instant les news de vos cryptomonnaie préférées</span>
          <p class="mt-7 paragraphe">Profiter des dernières news de vos crpyotmmaies. Vous resterez toujours à jour
            grâce aux news
            crypto.</p>
        </div>
      ...
      <div class="card-pres xl:w-1/4 xs:w-full flex flex-col mt-8 justify-evenly rounded-lg">
        ...
        <div class="mb-5 mr-5 ml-5">
          ...
          <p class=" mt-7 space-x-2 paragraphe text-justify font-medium">Gérer votre budgt de cryptommaie. Voir dans
            quoi vous avez
            investie et les dernieres transactions. Rester maître de votre wallet.</p>
        </div>
      </div>
    </div>
    <div class="w-full flex flex-col justify-center connect-container">
      <div
        ...
        Commencez à investir dans les cryptomonnaies maintenant !</div>
      <Button class="mb-10 button-landing-page self-center xl:w-1/6 sm:w-1/2 mt-15 font-bold mb-4 mt-10"
